...
subtitleLabel.Text = "Animation Track Detection"
...
statusDesc.Text = "Animation Track Detection • Frames: 0"
...
copyrightLabel.Text = "© Hunwo 2025 • v5.0 Track Detection"
...
local function updateStatus(state, animation, frames)
    ...
    statusDesc.Text = string.format("Animation Track Detection • Frames: %d", frames or 0)
...
local function startRecording()
    ...
    recordingConnection = RunService.Heartbeat:Connect(function()
        ...
        if humanoidRootPart and humanoidRootPart.Parent and character and character.Parent and bodyRecorder and humanoid then
            ...
            -- Deteksi state menggunakan animation tracks (paling akurat)
            ...
            -- Fallback ke JumpDetector jika tidak ada animasi khusus terdeteksi
...
print("║    ANIMATION TRACK DETECTION              ║")
print("╚═══════════════════════════════════════════╝")
print("")
print("✨ NEW IN v5.0:")
print("   • ANIMATION TRACK DETECTION")
print("   • Works with ALL custom animations")
print("   • Directly reads playing AnimationTracks")
print("   • Detects jump/fall/climb from track ID")
print("   • Fallback to physics-based detection")
print("")
print("🎮 How it works:")
print("   1. Check all playing animation tracks")
print("   2. Parse AnimationId for keywords:")
print("      - 'jump' → Jumping state")
print("      - 'fall' → Falling state")
print("      - 'climb' → Climbing state")
print("   3. If no special animation → Use velocity")
print("   4. Record state → Playback applies state")
print("")
print("✅ Jump detection now works with any animation!")

...
local function createSpeedDropdown(parent)
    ...
    dropdownContainer.Size = UDim2.new(1, -24, 0, 36)
    dropdownContainer.Position = UDim2.new(0, 12, 0, 152)
    ...
    dropdownBtn.Position = UDim2.new(0, 85, 0, 0)
    ...
    local arrowIcon = Instance.new("TextLabel", dropdownBtn)
    ...
    dropdownList.Position = UDim2.new(0, 85, 1, 4)
    ...
    dropdownBtn.MouseButton1Click:Connect(function()
        ...
        if speedDropdownOpen then
            ...
            TweenService:Create(dropdownList, TweenInfo.new(0.25, Enum.EasingStyle.Quad), {
                Size = UDim2.new(0, 120, 0, #speedOptions * 32)
            }):Play()
...
-- ====== Main UI Setup [v3.8 - COMPACT LAYOUT] ======
...
subtitleLabel.Text = "v3.8 - Compact Layout & Smooth Minimize"
...
-- ====== Unified Control Box (4 Buttons) ======
local controlBox = Instance.new("Frame", contentContainer)
controlBox.Size = UDim2.new(1, -24, 0, 116)
...
-- ====== Speed Dropdown ======
local speedDropdown = createSpeedDropdown(contentContainer)

-- ====== Replay List Box ======
local replayBox = Instance.new("Frame", contentContainer)
replayBox.Size = UDim2.new(1, -24, 0, 240)
replayBox.Position = UDim2.new(0, 12, 0, 200)
...
copyrightLabel.Text = "© Hunwo 2025 • v3.8"
...
minimizeBtn.MouseButton1Click:Connect(function()
    ...
    if isMinimized then
        -- Shrink panel with smooth animation
        ...
        -- Show circular button with pop animation
...
-- ====== Startup Message ======
print("╔═══════════════════════════════════════════╗")
print("║  AUTO WALK RECORDER PRO v3.8              ║")
print("║     Compact Layout & Smooth Minimize      ║")
print("╚═══════════════════════════════════════════╝")
print("")
print("✨ NEW: 4-button unified control layout")
print("✨ NEW: Speed dropdown (0.5x - 1.5x)")
print("✨ NEW: Smooth circular minimize button")
print("✨ FIXED: Compact UI design")
print("")
print("🎮 Features:")
print("   • Record, Save, Load, Queue in one box")
print("   • Adjustable playback speed")
print("   • Smooth minimize/restore animations")
print("   • Space-efficient dropdown menu")
print("")
print("💡 Press minimize to get a draggable circle!")

...
-- ====== UNIVERSAL JUMP Playback System v5.0 ======
    ...
    task.spawn(function()
        ...
        while index <= totalFrames do
            ...
            if humanoidRootPart and humanoidRootPart.Parent and character and character.Parent and currentReplayToken == token and bodyRecorder then
                ...
                -- USE RECORDED STATE DIRECTLY (this is the key fix!)
                ...
                -- Apply the recorded state (Jump detection happens during recording!)
                if animController and playbackState then
